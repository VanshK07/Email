...
if (isset($_POST['verification_code']) && !empty($_POST['verification_code'])) {
    ...
    if ($inputCode === $storedCode && !empty($email)) {
        registerEmail($email);
        $message = "Email successfully registered! You will receive GitHub timeline updates.";
...
<body>
    <div class="container">
        ...
        <form method="POST" action="">
            <div class="step-info">
                <strong>Step 1:</strong> Enter your email to receive GitHub timeline updates
            </div>
